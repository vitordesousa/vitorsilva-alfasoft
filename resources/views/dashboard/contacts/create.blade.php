            ...
            <div class="block mt-4 rounded-md shadow-2xl shadow-blue-900 p-6">
                <form method="POST" action="{{ route('dashboard.contacts.store') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="email_address" class="block mt-1 w-full" type="email" name="email_address" :value="old('email_address')" required autocomplete="email_address" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="contact" class="block mt-1 w-full" type="tel" name="contact" maxlength="9" :value="old('contact')" required autocomplete="phone" />
